            ...
            <div className="card-header border-0 pb-2 flex-wrap">
                ...
                <>
                    <Nav className="order nav nav-tabs">
                        <Nav.Link as="button"  eventKey="All"  type="button">Open Order</Nav.Link>
                        <Nav.Link as="button"  eventKey="Order" type="button">Closed Order</Nav.Link>
                        <Nav.Link as="button"  eventKey="Trade" type="button">Order Histroy</Nav.Link>
                    </Nav>
                </>
            </div>
