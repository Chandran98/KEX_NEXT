...
// import { swapHistory, swapcoins } from "@/redux/reducer/crypto/cryptoApi";
...
//           </h4>
//           <div className="row">
//             <form action="" onSubmit={handleSubmit(onSumbitForm)}>
...
//                       <div className="col-xl-6">
//                         <Select
//                         {...register("spentcurrency")}
//                           value={coin2}
//                           onChange={(data) => setCoin2(data)}
//                           className="custom-react-select mb-xl-0 mb-3"
//                           options={optionsData}
//                           isSearchable={false}
//                         />
