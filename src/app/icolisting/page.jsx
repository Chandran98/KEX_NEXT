                            ...
                            <div className="site-filters clearfix center m-b40">
                                <ul className="filters" data-bs-toggle="buttons">
                                    <li data-filter="" className={`btn ${activeGenre === 0 ? "active" : ""}`}>
                                        <Link href={"#"} className="site-button" onClick={()=>setActiveGenre(0)}>Show All</Link> 
                                    </li>
                                    <li data-filter=".infra" className={`btn ${activeGenre === 5 ? "active" : ""}`}>
                                        <Link href={"#"} className="site-button" onClick={()=>setActiveGenre(5)}>Infrastructure</Link>
                                        </li>
                                    <li data-filter=".gaming"  className={`btn ${activeGenre === 7 ? "active" : ""}`}>
                                        <Link href={"#"} className="site-button" onClick={()=>setActiveGenre(7)}>Gaming</Link> 
                                    </li>
